...
var siteComponentElementBaseSchema = {
  selector: external_exports.string().min(4).max(50),
...
async function readAppManifestFile(projectFolder) {
  ...
  return readLooseAppManifest(buildManifest.appManifestPath);
}

// ../cli-astro-commands/src/dev-center/components/load-dev-center-components.ts
async function loadDevCenterComponents(projectFolder) {
  try {
    const manifest = await readAppManifestFile(projectFolder);
...
//# sourceMappingURL=chunk-UD7IBXRB.js.map